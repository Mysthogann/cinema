...
const trenSinop = 'En un tren de alta velocidad que se dirige de Tokio a Morioka, cinco asesinos profesionales descubren que van tras el mismo objetivo.'
 ...
 document.getElementById("db").innerHTML = dragonBall[1]
 document.getElementById("ant").innerHTML = antMan[1]
 document.getElementById("thor").innerHTML = thor[1]
 document.getElementById("tb").innerHTML = trenBala[1]
